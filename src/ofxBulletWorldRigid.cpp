...
ofxBulletRaycastData ofxBulletWorldRigid::raycastTest(float a_x, float a_y, short int a_filterMask) {
    ...
    ofVec3f castRay2 = _camera->getGlobalPosition();
    ofVec3f castRay = _camera->screenToWorld( ofVec3f(a_x, a_y, 0) );
    ofVec3f castRay3;
    castRay3.set(castRay.x - castRay2.x, castRay.y - castRay2.y, castRay.z - castRay2.z);
    castRay3.normalize();
    castRay3 *= 10000;
    castRay3+=castRay;

    return raycastTest( castRay, castRay3, a_filterMask);
